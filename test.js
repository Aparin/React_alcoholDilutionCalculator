describe('calc', function() {
	...
	it('4-й блок расчётов: стартовая крепость внутри диапазона, конечная - тоже', function() {
		assert.equal(calc(94, 91), 3.8); // 6.4 * ( (94 - 91) / 5 )
		assert.equal(calc(94, 16), 501.8); 
		// hDiapason95 = 540 - (540 - 382) / 5 // 508.4
		// hDiapason90 = 505.3 - (505.3 - 355.8) / 5 // 475.4
		// res = 508.4 - (508.4 - 475.4) / 5 * 1 // 501.8
		
		assert.equal(calc(51, 19), 172.6); 
		// hDiapason55 = 267.3 - (267.3 - 176) / 5 * 4 // 194.26
		// hDiapason50 = 233.6 - (233.6 - 150.6) / 5 * 4 // 167.2
		// res = 194.26 - (194.26 - 167.2) / 5 * 4 // 172.6
	});
